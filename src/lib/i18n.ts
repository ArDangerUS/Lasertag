...
const uk = {
  ...
  pkgExtraLine: "+ {n} додаткових учасників × {fee} грн",
  pkgPerkExtra: "За кожного наступного учасника — {fee} грн",
  pkgTotalLine: "Разом: {sum} грн",
  phoneConsent: "Вводячи номер, ви даєте згоду на зв'язок щодо вашого бронювання.",
  phoneCall: "Подзвонити",
  phoneAddContact: "Додати в контакти",
  phoneCopy: "Скопіювати номер",
  phoneCopied: "Скопійовано ✓",
  backToSite: "На основний сайт",
  variantTitle: "Оберіть сценарій",
  variantAny: "Ще не визначилися",
  legendYourOther: "у вас тут інше",
  ...
  hoursShort: "год",
  peopleWord: "учасників",
  peopleUpTo: "до {n} учасників",
  peopleRange: "{a}–{b} учасників",
  maxPeopleWarn: "максимум {n} учасників — змініть кількість у кроці 3",
  extraPeopleNote: "понад {n} учасників — {fee} грн за кожного наступного",
  extraPeopleLine: "+ {c} × {fee} грн за учасників понад {n}",
...
const ru: Dict = {
  ...
  pkgExtraLine: "+ {n} дополнительных участников × {fee} грн",
  pkgPerkExtra: "За каждого следующего участника — {fee} грн",
  pkgTotalLine: "Итого: {sum} грн",
  phoneConsent: "Вводя номер, вы соглашаетесь на связь по поводу вашего бронирования.",
  phoneCall: "Позвонить",
  phoneAddContact: "Добавить в контакты",
  phoneCopy: "Скопировать номер",
  phoneCopied: "Скопировано ✓",
  backToSite: "На основной сайт",
  variantTitle: "Выберите сценарий",
  variantAny: "Ещё не определились",
  legendYourOther: "у вас здесь другое",
  ...
  hoursShort: "ч",
  peopleWord: "участников",
  peopleUpTo: "до {n} участников",
  peopleRange: "{a}–{b} участников",
  maxPeopleWarn: "максимум {n} участников — измените количество в шаге 3",
  extraPeopleNote: "свыше {n} участников — {fee} грн за каждого следующего",
  extraPeopleLine: "+ {c} × {fee} грн за участников свыше {n}",
...
const en: Dict = {
  ...
  pkgExtraLine: "+ {n} extra guests × {fee} uah",
  pkgPerkExtra: "Each additional guest — {fee} uah",
  pkgTotalLine: "Total: {sum} uah",
  phoneConsent: "By entering your number you agree to be contacted about your booking.",
  phoneCall: "Call",
  phoneAddContact: "Add to contacts",
  phoneCopy: "Copy number",
  phoneCopied: "Copied ✓",
  backToSite: "Back to main site",
  variantTitle: "Choose a scenario",
  variantAny: "Not decided yet",
  legendYourOther: "your other activity",
  ...
  extraPeopleNote: "over {n} guests — {fee} UAH for each extra one",
  extraPeopleLine: "+ {c} × {fee} UAH for guests over {n}",
