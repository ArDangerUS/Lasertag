...
const uk = {
  ...
  weekendBadge: "Вихідний / святковий тариф",
  stepDate: "ДАТА СВЯТА",
  ...
  packagesHint: "готова послідовність свята — додайте одним дотиком",
...
const ru: Dict = {
  ...
  weekendBadge: "Выходной / праздничный тариф",
  ...
  packagesHint: "готовая последовательность праздника — добавьте одним касанием",
...
const en: Dict = {
  ...
  weekendBadge: "Weekend / holiday rate",
  stepDate: "PARTY DATE",
  ...
  packagesHint: "a ready party sequence — add in one tap",
