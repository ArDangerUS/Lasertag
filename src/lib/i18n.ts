...
const uk = {
  ...
  pkgExtraLine: "+{n} учасн. понад {max}: +{sum} грн",
  pkgExtraHint: "Понад {max} учасників — доплата {fee} грн за кожного",
...
const ru: Dict = {
  ...
  pkgExtraLine: "+{n} участн. сверх {max}: +{sum} грн",
  pkgExtraHint: "Свыше {max} участников — доплата {fee} грн за каждого",
...
const en: Dict = {
  ...
  pkgExtraLine: "+{n} guests over {max}: +{sum} uah",
  pkgExtraHint: "Over {max} guests — {fee} uah surcharge per extra guest",
