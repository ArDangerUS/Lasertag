...
export const ACTIVITIES: SeedActivity[] = [
  ...
  // ---------------------------------------------------------------------
  // Шоу-програми та майстер-класи. Лише для CRM: на сайті бронювання їх
  // немає, клієнт домовляється по телефону. Тривалість — година, навіть
  // якщо сама програма коротша (кімната все одно закривається на годину).
  {
    key: "show-dryice",
    category: "show",
    nameUk: "Шоу «Сухий лід»",
    nameRu: "Шоу «Сухой лёд»",
    nameEn: "Dry ice show",
    descUk: "40 хв · бронюється на годину",
    descRu: "40 хв · бронируется на час",
    descEn: "40 хв · booked for a full hour",
    icon: "🧊",
    perPerson: false,
    // сама програма коротша, але кімната закривається на годину
    durationMin: 60,
    cleanupMin: 0,
    minPeople: 1,
    maxPeople: 999,
    ...
    sortOrder: 21,
    locations: ALL,
    prices: [{ weekday: 4500, weekend: 4500 }],
  },
  {
    key: "show-trash",
    category: "show",
    ...
    sortOrder: 22,
    locations: ALL,
    prices: [{ weekday: 5500, weekend: 5500 }],
  },
  {
    key: "show-neonbubble",
    category: "show",
    nameUk: "Неонове бульбашкове шоу",
    nameRu: "Неоновое пузырьковое шоу",
    nameEn: "Neon bubble show",
    descUk: "30 хв · бронюється на годину",
    descRu: "30 хв · бронируется на час",
    descEn: "30 хв · booked for a full hour",
    icon: "🫧",
    perPerson: false,
    // сама програма коротша, але кімната закривається на годину
    durationMin: 60,
  ...
  },
  {
    key: "mc-slime",
    category: "show",
    nameUk: "Майстер-клас: слайми",
    nameRu: "Мастер-класс: слаймы",
    nameEn: "Slime workshop",
    descUk: "40 хв · від 8 осіб · бронюється на годину",
    descRu: "40 хв · от 8 человек · бронируется на час",
    descEn: "40 хв · from 8 guests · booked for a full hour",
    icon: "🧪",
    perPerson: true,
    durationMin: 60,
    cleanupMin: 0,
    ...
    sortOrder: 25,
    locations: ALL,
    prices: [{ weekday: 500, weekend: 500 }],
  },
  {
    key: "mc-ecobag",
    category: "show",
    nameUk: "Майстер-клас: розмальовка еко-сумки",
    nameRu: "Мастер-класс: роспись эко-сумки",
    nameEn: "Eco bag painting",
    descUk: "40 хв · від 10 осіб · бронюється на годину",
    descRu: "40 хв · от 10 человек · бронируется на час",
    descEn: "40 хв · from 10 guests · booked for a full hour",
    icon: "👜",
    perPerson: true,
    durationMin: 60,
    cleanupMin: 0,
    ...
    sortOrder: 26,
    locations: ALL,
    prices: [{ weekday: 600, weekend: 600 }],
  },
  {
    key: "mc-sandbottle",
    category: "show",
    nameUk: "Майстер-клас: пляшки з пісочком",
    nameRu: "Мастер-класс: бутылочки с песком",
    nameEn: "Sand bottle workshop",
    descUk: "30 хв · від 8 осіб · бронюється на годину",
    descRu: "30 хв · от 8 человек · бронируется на час",
    descEn: "30 хв · from 8 guests · booked for a full hour",
    icon: "🏺",
    perPerson: true,
    durationMin: 60,
    cleanupMin: 0,
    ...
    sortOrder: 27,
    locations: ALL,
    prices: [{ weekday: 550, weekend: 550 }],
  },
  {
    key: "mc-tshirt",
    category: "show",
    nameUk: "Майстер-клас: розфарбовка футболки",
    nameRu: "Мастер-класс: роспись футболки",
    nameEn: "T-shirt painting",
    descUk: "40 хв · від 10 осіб · бронюється на годину",
    descRu: "40 хв · от 10 человек · бронируется на час",
    descEn: "40 хв · from 10 guests · booked for a full hour",
    icon: "👕",
    ...
    sortOrder: 28,
    locations: ALL,
    prices: [{ weekday: 750, weekend: 750 }],
  },
  {
    key: "mc-candles",
    category: "show",
    nameUk: "Майстер-клас: гелеві свічки",
    nameRu: "Мастер-класс: гелевые свечи",
    nameEn: "Gel candle workshop",
    descUk: "30 хв · від 8 осіб · бронюється на годину",
    descRu: "30 хв · от 8 человек · бронируется на час",
    descEn: "30 хв · from 8 guests · booked for a full hour",
    icon: "🕯️",
    ...
    sortOrder: 29,
    locations: ALL,
    prices: [{ weekday: 650, weekend: 650 }],
  },
  {
    key: "banquet",
    category: "room",
...
export type SeedVariant = {
  ...
  // Кімнати саме цього сценарію («loc:key»), якщо він іде не там, де решта.
  // Порожньо = кімнати самої розваги.
  roomRefs?: string[];
  sortOrder: number;
};
...
export const ACTIVITY_VARIANTS: SeedVariant[] = [
  ...
  },
  {
    ...
    locationSlugs: ALL_LOC,
    // Єдиний квест, який проводять не в квест-кімнаті, а на лазертаг-арені —
    // тож він займає арену, а не квест-кімнату.
    roomRefs: [
      "nyvky:arena",
      "new-way:arena",
      "dream-yellow:arena",
...
export const ROOMS: SeedRoom[] = [
  ...
  { loc: "gorodok", key: "showroom", name: "Кімната шоу-програм", note: "шоу та майстер-класи — бронює менеджер" },
...
export const ACTIVITY_ROOMS: Record<string, string[]> = {
  ...
  // Шоу-програми: Городок — окрема кімната шоу; Нивки — банкетні або
  // квест-кімната; New Way і Дрім — лише банкетні.
  "show-dryice": ["gorodok:showroom", "nyvky:banquet-cosmos-s", "nyvky:banquet-cosmos-l", "nyvky:quest", "new-way:banquet-cosmos", "new-way:banquet-kayuta", "new-way:banquet-minecraft", "dream-yellow:banquet"],
  "show-trash": ["gorodok:showroom", "nyvky:banquet-cosmos-s", "nyvky:banquet-cosmos-l", "nyvky:quest", "new-way:banquet-cosmos", "new-way:banquet-kayuta", "new-way:banquet-minecraft", "dream-yellow:banquet"],
  "show-neonbubble": ["gorodok:showroom", "nyvky:banquet-cosmos-s", "nyvky:banquet-cosmos-l", "nyvky:quest", "new-way:banquet-cosmos", "new-way:banquet-kayuta", "new-way:banquet-minecraft", "dream-yellow:banquet"],
  "show-magic": ["gorodok:showroom", "nyvky:banquet-cosmos-s", "nyvky:banquet-cosmos-l", "nyvky:quest", "new-way:banquet-cosmos", "new-way:banquet-kayuta", "new-way:banquet-minecraft", "dream-yellow:banquet"],
  // Майстер-класи: те саме, але на Нивках лише банкетні.
  "mc-slime": ["gorodok:showroom", "nyvky:banquet-cosmos-s", "nyvky:banquet-cosmos-l", "new-way:banquet-cosmos", "new-way:banquet-kayuta", "new-way:banquet-minecraft", "dream-yellow:banquet"],
  "mc-ecobag": ["gorodok:showroom", "nyvky:banquet-cosmos-s", "nyvky:banquet-cosmos-l", "new-way:banquet-cosmos", "new-way:banquet-kayuta", "new-way:banquet-minecraft", "dream-yellow:banquet"],
  "mc-sandbottle": ["gorodok:showroom", "nyvky:banquet-cosmos-s", "nyvky:banquet-cosmos-l", "new-way:banquet-cosmos", "new-way:banquet-kayuta", "new-way:banquet-minecraft", "dream-yellow:banquet"],
  "mc-tshirt": ["gorodok:showroom", "nyvky:banquet-cosmos-s", "nyvky:banquet-cosmos-l", "new-way:banquet-cosmos", "new-way:banquet-kayuta", "new-way:banquet-minecraft", "dream-yellow:banquet"],
  "mc-candles": ["gorodok:showroom", "nyvky:banquet-cosmos-s", "nyvky:banquet-cosmos-l", "new-way:banquet-cosmos", "new-way:banquet-kayuta", "new-way:banquet-minecraft", "dream-yellow:banquet"],
  banquet: [
...
const PERK_RU: Record<string, string> = {
  ...
  "60 хвилин – Квест": "60 минут – Квест",
...
export const PACKAGES: SeedPackage[] = [
  // Однакові комплекси продаються на кількох локаціях одним записом.
  {
    locationSlugs: ["nyvky", "new-way", "dream-yellow"], key: "stalker", icon: "🎯",
    maxPeople: 6, extraPersonFee: 1500,
  ...
  // VIP на Нивках і DREAM Yellow: паперове шоу 30 хв
  {
    locationSlugs: ["nyvky", "dream-yellow"], key: "vip", icon: "👑", maxPeople: 10,
  ...
  // VIP у ТРЦ New Way відрізняється: паперове шоу триває 60 хв
  {
    locationSlugs: ["new-way"], key: "newway-vip", icon: "👑", maxPeople: 10,
    nameUk: "Комплекс «VIP PARTY»", nameRu: "Комплекс «VIP PARTY»", nameEn: "“VIP PARTY” package",
  ...
  // ---------- ТРЦ Gorodok (унікальна програма) ----------
  {
    locationSlugs: ["gorodok"], key: "gorodok-start", icon: "🚀", maxPeople: 10,
  ...
  {
    locationSlugs: ["gorodok"], key: "gorodok-premium", icon: "⭐", maxPeople: 10,
  ...
  {
    locationSlugs: ["gorodok"], key: "gorodok-vipall", icon: "💎", maxPeople: 10,
