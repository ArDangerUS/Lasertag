...
export const ACTIVITIES: SeedActivity[] = [
  ...
  // немає, клієнт домовляється по телефону. Тривалість — фактична: 30 або
  // 40 хвилин, скільки триває сама програма.
  {
    key: "show-dryice",
    category: "show",
  ...
  },
  {
    ...
    descUk: "40 хв · від 8 осіб",
    descRu: "40 мин · от 8 человек",
    descEn: "40 min · from 8 guests",
    icon: "🧪",
    perPerson: true,
    durationMin: 40,
    cleanupMin: 0,
  ...
  },
  {
    ...
    descUk: "40 хв · від 10 осіб",
    descRu: "40 мин · от 10 человек",
    descEn: "40 min · from 10 guests",
    icon: "👜",
    perPerson: true,
    durationMin: 40,
    cleanupMin: 0,
  ...
  },
  {
    ...
    descUk: "30 хв · від 8 осіб",
    descRu: "30 мин · от 8 человек",
    descEn: "30 min · from 8 guests",
    icon: "🏺",
    perPerson: true,
    durationMin: 30,
    cleanupMin: 0,
